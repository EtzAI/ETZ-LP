...
const TestimonialCard = ({
  ...
  return (
    <div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-[#1C4259]/10 bg-gradient-to-b from-white to-[#f8fcfa] p-10 shadow-[0_12px_32px_rgba(28,66,89,0.06)]">
      <div className="absolute -top-5 -left-5 -z-10 h-40 w-40 rounded-full bg-gradient-to-b from-[#60BFA4]/12 to-transparent blur-md"></div>

      <div className="leading-relaxed text-[#1C4259]">{body}</div>

      <div className="mt-5 flex items-center gap-2">
        <img src={img || "/placeholder.svg"} alt={name} height="40" width="40" className="h-10 w-10 rounded-full" />
        <div className="flex flex-col">
          <div className="leading-5 font-medium tracking-tight text-[#0D261F]">{name}</div>
          <div className="leading-5 tracking-tight text-[#4D6B63]">{username}</div>
        </div>
      </div>
    </div>
  )
    ...
    <section id="testimonials" className="mb-24">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="relative text-[#0D261F]">Testimonials</span>
            </button>
          </div>
          <h2 className="__className_bb4e88 relative z-10 mt-5 bg-gradient-to-r from-[#0D261F] via-[#1C4259] to-[#60BFA4] bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px]">
            What our users say
          </h2>
        ...
        <div className="-mt-8 flex justify-center">
          <button className="group relative inline-flex items-center gap-2 rounded-full border border-[#1C4259]/10 bg-white px-6 py-3 text-sm font-medium text-[#0D261F] shadow-[0_12px_32px_rgba(28,66,89,0.08)] transition-all hover:border-[#60BFA4]/40 hover:bg-[#EEF8F5] active:scale-95">
            <div className="absolute inset-x-0 -top-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#60BFA4]/40 to-transparent"></div>
            <div className="absolute inset-x-0 -bottom-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#60BFA4]/40 to-transparent"></div>
            <svg className="h-4 w-4 text-[#1C4259]" fill="currentColor" viewBox="0 0 24 24">
